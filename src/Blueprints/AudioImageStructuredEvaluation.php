...
{
    private const CAPABILITY_AUDIO_TRANSCRIPTION = 'audio_transcription';
    private const CAPABILITY_STRUCTURED_OUTPUT = 'structured_output';
    private const CAPABILITY_IMAGE_INPUT = 'image_input';
    private const CAPABILITY_VISION = 'vision';
